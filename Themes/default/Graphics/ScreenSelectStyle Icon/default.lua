...
if choiceName == "Single" then -- 1 Player
	t[#t+1] = drawNinePanelPad(1, -xshift - 14, yshift)..{
		OffCommand=cmd(linear,0.2; diffusealpha,0)
	}

elseif choiceName == "Versus" then -- 2 Players
	t[#t+1] = drawNinePanelPad(1,-xshift - WideScale(70,80), yshift)..{
...
elseif choiceName == "Triple" then -- 3 Players
	t[#t+1] = drawNinePanelPad(1, -xshift*2 - WideScale(50,60), yshift)..{
		OffCommand=cmd(sleep,0.12; linear,0.2; diffusealpha,0)
	}
	t[#t+1] = drawNinePanelPad(5, -xshift - 8, yshift)..{
		OffCommand=cmd(sleep,0.24; linear,0.2; diffusealpha,0)
	}
	t[#t+1] = drawNinePanelPad(7, xshift*2 - WideScale(50,60), yshift)..{
		OffCommand=cmd(sleep,0.24; linear,0.2; diffusealpha,0)
	}

elseif choiceName == "Quad" then -- 4 Players
	t[#t+1] = drawNinePanelPad(1, -xshift - WideScale(60,70), yshift*2.33)..{
		OffCommand=cmd(sleep,0.12; linear,0.2; diffusealpha,0)
	}
	...
	t[#t+1] = drawNinePanelPad(10, xshift - WideScale(60,70), yshift)..{
		OffCommand=cmd(sleep,0.24; linear,0.2; diffusealpha,0)
	}
